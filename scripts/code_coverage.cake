...
{
    "../test/Wiz.RoteProcessing.Integration.Tests/Wiz.RoteProcessing.Integration.Tests.csproj",
    "../test/Wiz.RoteProcessing.Unit.Tests/Wiz.RoteProcessing.Unit.Tests.csproj"
};
